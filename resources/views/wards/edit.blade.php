    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Update ward details for staff assignment.</p>
            </div>
                ...
                <form method="POST" action="{{ route('wards.update', $ward) }}">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-text-input id="ward_name" class="block mt-1 w-full" type="text" name="ward_name" :value="old('ward_name', $ward->ward_name)" required autofocus />
