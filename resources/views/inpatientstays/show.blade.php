                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if ($inPatientStays->status !== 'discharged')
                        <div class="mt-8 pt-6 border-t">
                            <form action="{{ route('inpatientstays.discharge') }}" method="POST" onsubmit="return confirm('Are you sure you want to discharge this patient?');">
                                @csrf
                                <input type="hidden" name="stay_id" value="{{ $inPatientStays->stay_id }}">
